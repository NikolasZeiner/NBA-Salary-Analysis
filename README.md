...
| nba_analysis.R | R | Statistical analysis & charts |
...
## Dashboard Pages
1. Player Value Analysis — scatter plot, top 15 valuable & paid players
2. Team Analysis — payroll, value score, points by team
3. Player Deep Dive — searchable player table, value vs PER

## Skills Demonstrated
Python · pandas · R · ggplot2 · SQL · Power BI · DAX · Excel ·
PivotTables · XLOOKUP · COUNTIFS · Value Modeling · Sports Analytics
